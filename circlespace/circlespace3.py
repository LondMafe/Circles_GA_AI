...
for _ in range(num_circles):
    ...
    x = random.randint(20, canvas_width - 20)  # Asegurar que el círculo esté dentro del lienzo
    y = random.randint(20, canvas_height - 20)  # Asegurar que el círculo esté dentro del lienzo
